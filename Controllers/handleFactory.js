...
exports.createOne = (Model) =>
  catchAsync(async (req, res, next) => {
    ...
    // to pass some real data in create either we write it manually or we get the data from POST request
...
exports.getOne = (Model, popOptions) =>
  catchAsync(async (req, res, next) => {
    ...
    const doc = await query; // short-hand property for below statement.
